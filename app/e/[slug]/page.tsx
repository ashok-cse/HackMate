          ...
          <form onSubmit={(e) => void onSubmit(e)} className="space-y-5">
            ...
            <label className="flex items-start gap-3 text-sm">
              ...
              <span className="text-[var(--muted)]">
                I agree to be contacted for HackMate voice team matching, and I understand my answers are used only
                for hackathon team formation (GDPR-friendly processing).
              </span>
            </label>
